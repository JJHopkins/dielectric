...
ax.plot(n,sum_Li3    , color='#FFDD00')
ax.plot(n,sum_Li3_042, color='#FF9900')
ax.plot(n,sum_Li3_062, color='#FF5500')
ax.plot(n,sum_Li3_082, color='#FF0000')
ax.plot(n,sum_Li3_102, color='#663300')
ax.plot(n,sum_Li3_132, color='#660000')
...
ax_inset.plot(n,-dF_042, color='#FF9900', label = r'$\delta F(\omega_{0} = 0.64)$')
ax_inset.plot(n,-dF_062, color='#FF5500', label = r'$\delta F(\omega_{0} = 0.94)$')
ax_inset.plot(n,-dF_082, color='#FF0000', label = r'$\delta F(\omega_{0} = 1.25)$')
ax_inset.plot(n,-dF_102, color='#663300', label = r'$\delta F(\omega_{0} = 1.55)$')
ax_inset.plot(n,-dF_132, color='#660000', label = r'$\delta F(\omega_{0} = 2.01)$')
...
fig = pl.figure()
ax = fig.add_axes([0.1,0.1,0.8,0.8])
ax.plot(n,  eiz_nopeak, color='#FFDD00', label = r'$Ab\, initio$')#$ \epsilon (i \zeta )_{no \,peak} $')
ax.plot(n,eiz_042_peak, color='#FF9900', label = r'$\omega_{0} = 0.64$')
ax.plot(n,eiz_062_peak, color='#FF5500', label = r'$\omega_{0} = 0.94$')
ax.plot(n,eiz_082_peak, color='#FF0000', label = r'$\omega_{0} = 1.25$')
ax.plot(n,eiz_102_peak, color='#663300', label = r'$\omega_{0} = 1.55$')
ax.plot(n,eiz_132_peak, color='#660000', label = r'$\omega_{0} = 2.01$')
...
ax_inset.plot(n,diff_eiz_042,color= '#FF9900')#,linestyle='--')
ax_inset.plot(n,diff_eiz_062,color= '#FF5500')#,linestyle='--')
ax_inset.plot(n,diff_eiz_082,color= '#FF0000')#,linestyle='--')
ax_inset.plot(n,diff_eiz_102,color= '#663300')#,linestyle='--')
ax_inset.plot(n,diff_eiz_132,color= '#660000')#,linestyle='--')
...
pl.savefig('130923_shifted_eiz_deiz.png')
pp.savefig()
#####################################################################
dHs = [-2.2199921597 
,-1.29587958357 
