...
pp = PdfPages('plots/130801_Hopkins_eiz_output_increased_static.pdf')
...
x_nopeak_eV = loadtxt('data/Y23605L.txt', unpack=True, usecols = [0])
y_nopeak = loadtxt('data/Y23605L.txt', unpack=True, usecols = [1])
...
# We want to shift the spectrum so that we get higher values for the Int(w^(-1)*eps2...)
#----------------------------------------------------------
x_nopeak  = x_nopeak_eV  +6.#1.*10**(16)#+ - x_nopeak_eV[100]#
x_042_peak= x_042_peak_eV+6.#1.*10**(16)#+ - x_nopeak_eV[100]#
x_062_peak= x_062_peak_eV+6.#1.*10**(16)#+ - x_nopeak_eV[100]#
x_082_peak= x_082_peak_eV+6.#1.*10**(16)#+ - x_nopeak_eV[100]#
x_102_peak= x_102_peak_eV+6.#1.*10**(16)#+ - x_nopeak_eV[100]#
x_132_peak= x_132_peak_eV+6.#1.*10**(16)#+ - x_nopeak_eV[100]#
x_182_peak= x_182_peak_eV+6.#1.*10**(16)#+ - x_nopeak_eV[100]#
...
savetxt("data/eiz_nopeak_static.txt", eiz_nopeak)
savetxt("data/eiz_042_peak_static.txt", eiz_042_peak)
savetxt("data/eiz_062_peak_static.txt", eiz_062_peak)
savetxt("data/eiz_082_peak_static.txt", eiz_082_peak)
savetxt("data/eiz_102_peak_static.txt", eiz_102_peak)
savetxt("data/eiz_132_peak_static.txt", eiz_132_peak)
savetxt("data/eiz_182_peak_static.txt", eiz_182_peak)
