...
A_dep = linspace(0.0000000000001,7,300)#(0.000001,10,20)
rho = linspace(  0.0000000000001,5,300)
...
#
#figure()
#levels = [0.20,0.40]#,0.80,1.00]
#contourf(X,Y,height, 100, extend = 'both', cmap = autumn());cbar = colorbar(); clim(0,1);
#CS=contour(X,Y,height, levels)#, colors = 'k')
#clabel(CS,fmt = '%2.1f',colors = 'k',fontsize = 18)
#cbar.add_lines(CS)
...
####figure()
####levels = [0.20,0.40,0.60]#,0.80,1.00]
####contourf(X,Y,height, 100, extend = 'both', cmap = cool());cbar = colorbar(); clim(0,1.2);
####CS=contour(X,Y,height, levels)#, colors = 'k')
####clabel(CS,fmt = '%2.1f',colors = 'k',fontsize = 18)
####cbar.add_lines(CS)
####show()
...
#figure()
#levels = [0.20,0.40]#,0.80,1.00]
#contourf(X,Y,height, 100, extend = 'both', cmap = copper());cbar = colorbar(); clim(0,2);
#CS=contour(X,Y,height, levels)#, colors = 'k')
#clabel(CS,fmt = '%2.1f',colors = 'k',fontsize = 18)
#cbar.add_lines(CS)
#
#figure()
#levels = [0.20,0.40]#,0.80,1.00]
#contourf(X,Y,height, 100, extend = 'both', cmap = jet());cbar = colorbar(); clim(0,3);
#CS=contour(X,Y,height, levels)#, colors = 'k')
#clabel(CS,fmt = '%2.1f',colors = 'k',fontsize = 18)
#cbar.add_lines(CS)
#
#figure()
#levels = [0.20,0.40]#,0.80,1.00]
#contourf(X,Y,height, 100, extend = 'both', cmap = summer());cbar = colorbar(); clim(0,4);
#CS=contour(X,Y,height, levels)#, colors = 'k')
#clabel(CS,fmt = '%2.1f',colors = 'k',fontsize = 18)
#cbar.add_lines(CS)
#
#figure()
#levels = [1.20,2.40]#,0.80,1.00]
#contourf(X,Y,height, 100, extend = 'both', cmap = winter());cbar = colorbar(); clim(1,3);
#CS=contour(X,Y,height, levels)#, colors = 'k')
#clabel(CS,fmt = '%2.1f',colors = 'k',fontsize = 18)
#cbar.add_lines(CS)
#
#figure()
#levels = [1.20,3.40]#,0.80,1.00]
#contourf(X,Y,height, 100, extend = 'both', cmap = spring());cbar = colorbar(); clim(1,4);
#CS=contour(X,Y,height, levels)#, colors = 'k')
#clabel(CS,fmt = '%2.1f',colors = 'k',fontsize = 18)
#cbar.add_lines(CS)
