...
pp = PdfPages('plots/130801_Hopkins_increase_static_dF_DF.pdf')

x_nopeak_eV,y_nopeak=np.loadtxt('data/Y23605L.txt'  , unpack=True, usecols = [0,1])
x_nopeak = x_nopeak_eV + 6.# x_nopeak_eV[100]
eiz_nopeak   = np.loadtxt('data/eiz_nopeak_static.txt'  , unpack=True, usecols = [0])
eiz_042_peak = np.loadtxt('data/eiz_042_peak_static.txt', unpack=True, usecols = [0])
eiz_062_peak = np.loadtxt('data/eiz_062_peak_static.txt', unpack=True, usecols = [0])
eiz_082_peak = np.loadtxt('data/eiz_082_peak_static.txt', unpack=True, usecols = [0])
eiz_102_peak = np.loadtxt('data/eiz_102_peak_static.txt', unpack=True, usecols = [0])
eiz_132_peak = np.loadtxt('data/eiz_132_peak_static.txt', unpack=True, usecols = [0])
eiz_182_peak = np.loadtxt('data/eiz_182_peak_static.txt', unpack=True, usecols = [0])
