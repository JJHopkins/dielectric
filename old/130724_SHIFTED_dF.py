...
pp = PdfPages('plots/130724_Hopkins_shifted_df_DF.pdf')

x_nopeak,y_nopeak=np.loadtxt('130723_data/Y23605L.txt'  , unpack=True, usecols = [0,1])
eiz_nopeak   = np.loadtxt('130723_data/eiz_nopeak.txt'  , unpack=True, usecols = [0])
eiz_042_peak = np.loadtxt('130723_data/eiz_042_peak.txt', unpack=True, usecols = [0])
eiz_062_peak = np.loadtxt('130723_data/eiz_062_peak.txt', unpack=True, usecols = [0])
eiz_082_peak = np.loadtxt('130723_data/eiz_082_peak.txt', unpack=True, usecols = [0])
eiz_102_peak = np.loadtxt('130723_data/eiz_102_peak.txt', unpack=True, usecols = [0])
eiz_132_peak = np.loadtxt('130723_data/eiz_132_peak.txt', unpack=True, usecols = [0])
eiz_182_peak = np.loadtxt('130723_data/eiz_182_peak.txt', unpack=True, usecols = [0])
