...
#----------------------------------------------------------
x_042_peak_eV, y_042_peak =loadtxt('130711_Y24701L.txt', unpack=True, usecols = [0,1])# L => eps2: peak at 4.2
x_062_peak_eV, y_062_peak =loadtxt('130711_Y24702L.txt', unpack=True, usecols = [0,1])# L => eps2: peak at 6.2
x_082_peak_eV, y_082_peak =loadtxt('130711_Y24204L.txt', unpack=True, usecols = [0,1])# L => eps2: peak at 8.2
x_102_peak_eV, y_102_peak =loadtxt('130711_Y24703L.txt', unpack=True, usecols = [0,1])# L => eps2: peak at 10.2
x_132_peak_eV, y_132_peak =loadtxt('130711_Y24704L.txt', unpack=True, usecols = [0,1])# L => eps2: peak at 13.2
x_182_peak_eV, y_182_peak =loadtxt('130711_Y24705L.txt', unpack=True, usecols = [0,1])# L => eps2: peak at 18.2
