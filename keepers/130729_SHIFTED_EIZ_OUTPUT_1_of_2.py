...
pl.plot(x_042_peak*1.5187*10**(15)*10**(-16), y_042_peak, label =r'$\omega_{0} = 0.64$')
pl.plot(x_062_peak*1.5187*10**(15)*10**(-16), y_062_peak, label =r'$\omega_{0} = 0.94$')
pl.plot(x_082_peak*1.5187*10**(15)*10**(-16), y_082_peak, label =r'$\omega_{0} = 1.25$')
pl.plot(x_102_peak*1.5187*10**(15)*10**(-16), y_102_peak, label =r'$\omega_{0} = 1.55$')
pl.plot(x_132_peak*1.5187*10**(15)*10**(-16), y_132_peak, label =r'$\omega_{0} = 2.01$')
pl.plot(x_182_peak*1.5187*10**(15)*10**(-16), y_182_peak, label =r'$\omega_{0} = 2.76$')
