...
ax.plot(n,sum_Li3_042, color='g')
ax.plot(n,sum_Li3_062, color='r')
ax.plot(n,sum_Li3_082, color='c')
...
ax_inset.plot(n,dF_042, color='g', label = r'$\delta F(\omega_{0} = 0.64)$')
ax_inset.plot(n,dF_062, color='r', label = r'$\delta F(\omega_{0} = 0.94)$')
ax_inset.plot(n,dF_082, color='c', label = r'$\delta F(\omega_{0} = 1.25)$')
...
pl.ylabel(r'$\delta\mathrm{\left(\frac{F}{S}\right)}\frac{12\pi D^{2} }{k_{B} T}$', size = 14)
pl.axis([0,150,-0.07,0.01])
#pl.legend(loc = 'best')
...
ax.plot(n,eiz_042_peak, color='g', label = r'$\omega_{0} = 0.64$')
ax.plot(n,eiz_062_peak, color='r', label = r'$\omega_{0} = 0.94$')
ax.plot(n,eiz_082_peak, color='c', label = r'$\omega_{0} = 1.25$')
...
pl.xlabel(r'$N$', size = 21)
pl.ylabel(r'$ \epsilon (i \xi_{N} ) $', size = 21)
...
ax_inset.plot(n,diff_eiz_042,color= 'g')#,linestyle='--')
ax_inset.plot(n,diff_eiz_062,color= 'r')#,linestyle='--')
ax_inset.plot(n,diff_eiz_082,color= 'c')#,linestyle='--')
...
pl.ylabel(r'$ \delta \epsilon (i  \xi_{N} )$',size = 14)
