...
# Fit MEASURED peaks
#
x_data_expt, y_data_expt = numpy.loadtxt('x_peak.txt', unpack=True, usecols = [0,1])
...
# Fit CALCULATED data
#
x_data_theory, y_data_theory = numpy.loadtxt('x_nopeak.txt', unpack=True, usecols = [0,1])
