...
x_nopeak,y_nopeak = numpy.loadtxt('DATA/Y23605L_np.PRN', unpack=True, usecols = [0,1])

#x_peak = numpy.loadtxt('DATA/130710_eiz_output_x_peak.txt', unpack=True, usecols = [0])
x_peak,y_peak = numpy.loadtxt('DATA/Y24903L_pk.PRN', unpack=True, usecols = [0,1])# L => eps2
