...
pl.figure()
pl.plot(n,-dF_042*n, color='c', label = r'$\delta F(\omega_{0} = 0.64)$')
pl.plot(n,-dF_062*n, color='r', label = r'$\delta F(\omega_{0} = 0.94)$')
pl.plot(n,-dF_082*n, color='g', label = r'$\delta F(\omega_{0} = 1.25)$')
pl.plot(n,-dF_102*n, color='m', label = r'$\delta F(\omega_{0} = 1.55)$')
pl.plot(n,-dF_132*n, color='y', label = r'$\delta F(\omega_{0} = 2.01)$')
pl.plot(n,-dF_182*n, color='k', label = r'$\delta F(\omega_{0} = 2.76)$')
centers = [
 1./0.638
,1./0.942
,1./1.245
...
,1./2.764]
pl.figure()
pl.plot(n,-dF_042/0.638, color='c', label = r'$\delta F(\omega_{0} = 0.64)$')
pl.plot(n,-dF_062/0.942, color='r', label = r'$\delta F(\omega_{0} = 0.94)$')
pl.plot(n,-dF_082/1.245, color='g', label = r'$\delta F(\omega_{0} = 1.25)$')
pl.plot(n,-dF_102/1.549, color='m', label = r'$\delta F(\omega_{0} = 1.55)$')
pl.plot(n,-dF_132/2.005, color='y', label = r'$\delta F(\omega_{0} = 2.01)$')
pl.plot(n,-dF_182/2.764, color='k', label = r'$\delta F(\omega_{0} = 2.76)$')
#####################################################################
#fig = pl.figure()
